...
<body>
    ...
    <section class="row" style="width: 100%;">
    	...
    	<div class="col-sm-4 no-mobile" style = "height: 100vh; display: flex; justify-content: center; align-items: center;"><img src="designlogo.jpeg" alt="bit" class="img-fluid"></div>
    	<!--vertical forms-->
	    	...
	    	<div class="">
		        <div class="row">
		            ...
		            <div class="col-sm-8 mx-auto">
		                <div class="card">
		                    <div class="card-header bg-white text-center h4 text-white"><img src = "designlogo.jpeg" alt="image" width = "30%"/></div>
		                    <div class="card-body">
