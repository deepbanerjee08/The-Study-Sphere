...
<body data-bs-spy="scroll" data-bs-target="#myScrollSpy" data-bs-offset="0" tabindex="0">
	...
	%>
        ...
        <div class="bg-grey">
            ...
            <p>We bring you a collection of short, powerful messages crafted to uplift your spirits and remind the students of the incredible potential that resides within each of them</p>
        </div>
